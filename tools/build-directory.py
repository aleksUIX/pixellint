...
VENDORS = {
    ...
    "parsely": ("Parse.ly", "analytics", ["p1.parsely.com", "p1-irl.parsely.com", "cdn.parsely.com"], None),
    ...
    "cloudflare": ("Cloudflare Web Analytics", "analytics", ["static.cloudflareinsights.com"], "vendor/cloudflare"),
