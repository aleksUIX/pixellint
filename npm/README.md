...
- Vendor parameter contracts for twenty-eight endpoint families, each cited to the
  vendor's own documentation
- Endpoint attribution for 89 vendors, so an unrecognized pixel still gets a name
